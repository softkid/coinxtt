...
import stratinfo from './components/layout/strategy.vue'
import strategyDetail from './components/layout/strategydetail.vue'
...
import systemtradeList from './components/systemtrade/list.vue'
import addSystemTrade from './components/systemtrade/add.vue'
import publicStratrunner from './components/systemtrade/singleStratrunner.vue'
...
const router = new VueRouter({
  ...
  base: __dirname,
  routes: [
    { path: '/', redirect: '/system-trade' },
    { path: '/system-trade', component: systemtradeList },
    { path: '/system-trade/add', component: addSystemTrade },
    { path: '/system-trade/stratrunner/:id', component: publicStratrunner },
    { path: '/system-trade/watcher/:id', component: singleWatcher },
    { path: '/strategy-info', component: stratinfo }, 
    { path: '/strategy-info/:id', component: strategyDetail },
